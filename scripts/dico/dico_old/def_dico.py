...
with open('dico_pos_x_y.txt', 'w') as fichier:
    fichier.write("{\n")
    for cle, valeur in dico_coordonnee.items():
...
with open('dico_distances.txt', 'w') as fichier:
    fichier.write("{\n")
    for cle, valeur in distance_case.items():
        fichier.write(f"  {cle}: {valeur},\n")
    fichier.write("}")
...
with open('dico_amplitude.txt', 'w') as fichier:
    fichier.write("{\n")
    for cle, valeur in amplitude.items():
        fichier.write(f"  {cle}: {valeur},\n")
    fichier.write("}")
...
with open('dico_amplitude_binaire.txt', 'w') as fichier:
    fichier.write("{\n")
    for cle, valeur in amplitude_binaire.items():
        fichier.write(f"  {cle}: {valeur},\n")
    fichier.write("}")
...
with open('dico_amplitude_bin_id.txt', 'w') as fichier:
    fichier.write("{\n")
    for cle, valeur in amplitude_binaire_id.items():
        fichier.write(f"  {cle}: {valeur},\n")
    fichier.write("}")
...
with open('dico_coord_sans_para.txt', 'w') as fichier:
    fichier.write("{\n")
    for cle, valeur in dico_coord_sans_para.items():
        fichier.write(f"  {cle}: {valeur},\n")
    fichier.write("}")
...
with open('tableau_coord_case.txt', 'w') as fichier:
    fichier.write("[")
    for element in tableau_de_pierre:
