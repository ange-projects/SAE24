    ...
    <header>
        <nav> <!--Scrolling menu-->
            <ul>
                ...
                <li>
                    <a href="plan.php">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings"><circle cx="12" cy="12" r="3"></circle>
                        ...
                        <span class="nav-item">Schéma visiteur</span>
                    </a>
                </li>
                <li>
                    <a href="login.php">
